		...
		_createClass(Hello, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					_slider2.default,
					{ params: { transition: 0.5, delay: 4000, isAuto: true, isDot: true, width: window.innerWidth } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slider = function (_Component) {
		...
		_createClass(Slider, [{
			...
			value: function loop() {
				...
				var delay = this.props.params.delay;
	
				var fn = function fn() {
					_this2.next();
					_this2.timer = setTimeout(fn, delay);
				};
			...
			value: function handleTouchMove(e) {
				...
				var dis = tt.pageX - this.state.startX;
				this.setState({
					offX: dis
				});
			}
			...
			value: function handleTouchEnd(e) {
				...
				var width = _props$params.width;
				var isAuto = _props$params.isAuto;
				...
				var tt = e.changedTouches[0];
				var offX = tt.pageX - startX;
				var endTime = new Date();
				var touchTime = endTime.getTime() - startTime.getTime();
			...
			value: function componentDidMount() {
				//		let {list} = this.refs;
				var isAuto = this.props.params.isAuto;
				/*let fn = () => {
	   	this.setState({
	   		isBusy: false
	   	});
			...
			value: function render() {
				...
				var children = this.props.children;
				var transition = this.props.params.transition;
				var _props$params2 = this.props.params;
				var isDot = _props$params2.isDot;
				var width = _props$params2.width;
				var _state2 = this.state;
				var index = _state2.index;
				var offX = _state2.offX;
				var isTouch = _state2.isTouch;
				var direction = _state2.direction;
				//		transition = isTouch ? 0 : `${transition}s`;
	
				var len = children.length;
				var prev = index === 0 ? len - 1 : index - 1;
				var next = index === len - 1 ? 0 : index + 1;
				var transformType = document.documentElement.style.transform ? 'transform' : 'WebkitTransform';
				var style = function style(i) {
					if (i === prev) {
						var _ref;
	
						return _ref = {}, _defineProperty(_ref, transformType, 'translate3d(' + (-1 * width + offX) + 'px,0,0)'), _defineProperty(_ref, 'transition', direction === 'left' || isTouch ? '0s' : transition + 's'), _ref;
					} else if (i === index) {
						var _ref2;
	
						return _ref2 = {}, _defineProperty(_ref2, transformType, 'translate3d(' + offX + 'px,0,0)'), _defineProperty(_ref2, 'transition', isTouch ? '0s' : transition + 's'), _ref2;
					} else if (i === next) {
						var _ref3;
	
						return _ref3 = {}, _defineProperty(_ref3, transformType, 'translate3d(' + (1 * width + offX) + 'px,0,0)'), _defineProperty(_ref3, 'transition', direction === 'right' || isTouch ? '0s' : transition + 's'), _ref3;
					} else {
						return null;
					}
				};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						{ ref: 'list', onTouchStart: this.handleTouchStart.bind(this), onTouchMove: this.handleTouchMove.bind(this), onTouchEnd: this.handleTouchEnd.bind(this) },
						_react2.default.Children.map(children, function (v, i) {
							if (i === prev) {
								return _react2.default.createElement(
									'li',
									{ className: 'item', key: i, style: style(i) },
									v
								);
							} else if (i === index) {
								return _react2.default.createElement(
					...
					isDot ? _react2.default.createElement(
						'div',
						{ className: 'dots' },
						children.map(function (v, i) {
							return _react2.default.createElement('a', { key: i, className: _this3.state.index === i ? 'active' : 'dot', style: { transition: transition + 's' } });
						})
					) : null
				);
			}
	...
	Slider.propTypes = {
		isAuto: _react2.default.PropTypes.bool.isRequired,
		isDot: _react2.default.PropTypes.bool.isRequired
	};
...
/***/ }
/******/ ]);
//# sourceMappingURL=react-slider.bundle.js.map